...
import { Eye, EyeOff, Mail, Lock, Loader2, Facebook, Twitter } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white">SocialFlow Pro</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-2">Manage all your social media in one place</p>
        </div>
